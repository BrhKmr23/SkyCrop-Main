export const enTranslations = {
  ...
  cards: {
    ...
    desc1: "Water management system that optimizes irrigation based on soil moisture levels",
  ...
  dashboard: { // Added based on ta.ts structure
    ...
    metrics: {
      ...
      status: { // Added status messages
        ...
        predicted: "Sucessfully Predicted"
      }
    },
    forecast: {
      weather: {
        ...
        details: {
          wind: "Wind",
          chanceOfRain: "Chances of Rainfall"
        }
      },
      crop: {
        title: "Crop Forecast",
    ...
    activityFeed: {
      ...
      irrigationActivated: {
        ...
        description: "Automated irrigation delivered 2.5 Litres/m² of water."
      },
      temperatureAlert: {
      ...
      rainDetected: {
        ...
        description: "Light rainfall (2mm) detected. Irrigation schedule has been adjusted accordingly."
      },
      pestAlert: {
  ...
  footer: { // Added based on ta.ts
    copyright: "© {year} SkyCrop by AgroCare. All rights reserved.",
  ...
  aboutPage: { // Added based on ta.ts
    title: "About AgroCare",
    subtitle: "We are a team of Motivated Agricultural technology enthusiasts dedicated to empower farmers with smart farming solutions that increase productivity while promoting sustainability.",
    mission: {
      title: "Our Mission",
      text: "To simplify and revolutionize agriculture through accessible technology that helps farmers make data-driven decisions, optimize resource usage, and increase crop yields sustainably."
    },
    vision: {
      title: "Our Vision",
    ...
    team: {
      title: "Our Team",
      member1: { name: "Bharath Kumar", role: "ML engineer", desc: "Expert in Machine Learning and GenAI applications for agriculture." },
      member2: { name: "Madannpriyan", role: "Research and analyst", desc: "Specializes in Data analytics and Market research." },
      member3: { name: "Mohamed Ashfaq", role: "ML engineer", desc: "Experienced in Machine Learning and GenAI based applications for Agriculture" },
      member4: { name: "Nandhini", role: "Communication manager", desc: "Manages Communications and outreach to the farming community." },
      member5: { name: "Sanjeev", role: "IOT engineer", desc: "Developer of IoT solutions for smart and efficient farming technologies." },
    },
    achievements: {
      ...
      achievement3: {
        ...
        description: "Milestone reached in Q1 2025, with presence in 7 countries"
      }
    }
  },
  supportPage: { // Added based on ta.ts
    title: "Support Center",
    subtitle: "We're here to help you get the most out of your SkyCrop experience. Please browse our resources or contact us directly via Phone call or E-mail.",
    faq: {
      title: "Frequently Asked Questions",
      q1: {
        title: "How do I install sensors in my field?",
        answer: "Our sensors are designed for easy installation. Follow our step-by-step guide in the installation manual provided or watch our tutorial videos. If you need assistance, our technical team can schedule a remote session to help you."
      },
      q2: {
      ...
      q3: {
        title: "Can I use SkyCrop in areas with poor internet?",
  ...
  notFoundPage: { // Added based on ta.ts
    message: "Page not found, please try refreshing the page or return to home.",
